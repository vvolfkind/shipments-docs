...
> **Nota:** Contratos técnicos Andreani/OOLL: `domain-model.md` §1.1 y §4.4, `plan.md` § B.5. Este doc es **contexto de negocio / físico**; algunos ejemplos pueden estar desactualizados vs código.
